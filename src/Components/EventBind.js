...
// Using Arrow fuction would be preferably the best way to bind because we don't need to bind the 'this' Object  (Arrow function) 
class EventBind extends Component{
    ...
    render(){
        return(
            <div>
                <h1>{this.state.name}</h1>
                <button onClick={this.HelloEvent}>Click1</button> 
            </div>
        )
    }
}
